        ...
        <nav class="navbar navbar-expand-custom navbar-mainbg">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                    <a class="nav-link" href="/workshop_crti/site/index.php"><i class="lnr lnr-home"></i>HOME</a></li>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#about"><i class="lnr lnr-book"></i> ABOUT</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#TOPICS"><i class="lnr lnr-bookmark"></i> TOPICS</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#Committees"><i class="lnr lnr-users"></i> COMMITTEE</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#Registration"><i class="lnr lnr-calendar-full"></i> REGISTRATION</a>
                    </li>
                    <li class="nav-item">
